      ...
      body: ListView(
        children: [
          Center(
            child: Column(
              children: [ 
                Image.asset("assets/characters/just_photo.webp", width: 250, height: 250,),
                Text("Shrek tinder ❤️", style: GoogleFonts.aBeeZee(textStyle: Theme.of(context).textTheme.titleLarge),),
              ],
            ),
          ),
          SwitchListTile(
